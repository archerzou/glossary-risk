            ...
            <div className="space-y-6">
              ...
              <div className="text-right space-y-2">
                <div className="space-y-1 text-sm font-semibold uppercase tracking-wide">
                  ...
                  <Link href="https://www.sra.org/risk-analysis-specialty-groups/" className="block hover:underline">
                    RISK ANALYSIS SPECIALTY GROUPS
                  </Link>
                  <Link href="https://www.sra.org/resources/" className="block hover:underline">
                    RESOURCES
                  </Link>
                  <Link href="https://www.sra.org/news/" className="block hover:underline">
                    NEWS
                  </Link>
                  <Link href="https://www.sra.org/events-webinars/" className="block hover:underline">
                    EVENTS AND WEBINARS
                  </Link>
                  <Link href="https://www.sra.org/membership/" className="block hover:underline">
                    MEMBERSHIP
                  </Link>
                  <Link href="https://www.sra.org/journal/" className="block hover:underline">
                    JOURNAL
                  </Link>
                  <Link href="https://www.sra.org/about-sra/" className="block hover:underline">
                    ABOUT SRA
                  </Link>
                </div>
              </div>
